...
const NAV_CONFIG: Record<string, { id?: string; icon?: string; label?: string; section?: string; badgeKey?: string }[]> = {
  admin: [
    ...
    { id: 'preplans', icon: 'file', label: '预案管理' },
    { id: 'registrations', icon: 'file', label: '报名管理' },
    { id: 'awards', icon: 'gift', label: '获奖管理' },
    { section: '数据洞察' },
    { id: 'evaluations', icon: 'star', label: '学生评价' },
    { id: 'stats', icon: 'chart', label: '统计分析' },
    { id: 'analytics', icon: 'chart', label: '数据分析中心' },
    { id: 'kanban', icon: 'kanban', label: '看板总览' },
    { id: 'insights', icon: 'lightbulb', label: 'AI 洞察' },
    { id: 'leaderboard', icon: 'trophy', label: '排行榜' },
    { id: 'showcase', icon: 'award', label: '成果展示' },
    { id: 'achievement-gallery', icon: 'award', label: '成就展示墙' },
    { id: 'points', icon: 'star', label: '积分成就' },
    { id: 'compare', icon: 'chart', label: '赛事对比' },
    { id: 'learning-path', icon: 'map', label: '学习路径' },
    { id: 'annual-report', icon: 'chart', label: '年度报告' },
    { section: '智能助手' },
    { id: 'aitools', icon: 'sparkles', label: 'AI 工具箱' },
    { id: 'coach', icon: 'target', label: '赛事陪练' },
    { id: 'assistant', icon: 'sparkles', label: 'AI 助手' },
    { id: 'execution-match', icon: 'chart', label: '执行匹配' },
  ...
  teacher: [
    ...
    { id: 'preplans', icon: 'file', label: '预案审核' },
    { id: 'registrations', icon: 'file', label: '报名管理' },
  ...
  student: [
    ...
    { id: 'growth', icon: 'target', label: '成长档案' },
    { id: 'learning-path', icon: 'map', label: '学习路径' },
    { section: '项目管理' },
    ...
    { id: 'assistant', icon: 'sparkles', label: 'AI 助手' },
    { id: 'execution-match', icon: 'chart', label: '执行匹配' },
    { id: 'knowledge-base', icon: 'db', label: '知识库' },
    { section: '反馈' },
