...
async def _safe_tool_call(fn, *args, **kwargs) -> dict:
...
async def business_plan(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.business_plan, project_info=body.input)
...
async def market_analysis(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.market_analysis, industry=industry, target_market=target_market)
...
async def improvement_suggestions(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.improvement_suggestions, project_description=body.input)
...
async def tech_route(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.tech_route, requirements=requirements, team_skills=team_skills)
...
async def resource_integration(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.resource_integration, team_info=team_info, project_needs=project_needs)
...
async def pitch_deck(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.pitch_deck, project_info=project_info, duration=duration)
...
async def swot_analysis(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.swot_analysis, project_info=project_info, competitors=competitors)
...
async def competition_advisor(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.competition_advisor, project_status=project_status, time_remaining=time_remaining)
...
async def competition_report(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.competition_report, competition_info=body.input)
...
async def study_plan(body: ToolRequest) -> dict:
    ...
    return await _safe_tool_call(tool_service.study_plan, competition_info=competition_info, team_info=team_info)
...
async def parse_competition(body: ParseCompetitionRequest) -> dict:
    ...
    try:
        data = await asyncio.to_thread(parse_competition_text, body.content)
