...
const ROLE_CFG = {
  ...
  student: {
    ...
    nav:[
      ...
      { id:'showcase',     icon:'trophy',  label:'成果展示' },
    ],
  },
};
...
const PAGE_LABELS = {
  ...
  aitools:'AI 工具箱', users:'用户管理', calendar:'赛事日历', knowledgebase:'知识库',
  showcase:'成果展示',
};
